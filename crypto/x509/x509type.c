...
///// OQS_TEMPLATE_FRAGMENT_LIST_SIG_SWITCH_CASES_START
    ...
    case EVP_PKEY_P256_RAINBOWICIRCUMZENITHAL:
    case EVP_PKEY_RSA3072_RAINBOWICIRCUMZENITHAL:
    case EVP_PKEY_RAINBOWICOMPRESSED:
    case EVP_PKEY_P256_RAINBOWICOMPRESSED:
    case EVP_PKEY_RSA3072_RAINBOWICOMPRESSED:
    case EVP_PKEY_RAINBOWIIICLASSIC:
    case EVP_PKEY_P384_RAINBOWIIICLASSIC:
    case EVP_PKEY_RAINBOWIIICIRCUMZENITHAL:
    case EVP_PKEY_P384_RAINBOWIIICIRCUMZENITHAL:
    case EVP_PKEY_RAINBOWIIICOMPRESSED:
    case EVP_PKEY_P384_RAINBOWIIICOMPRESSED:
    case EVP_PKEY_RAINBOWVCLASSIC:
    case EVP_PKEY_P521_RAINBOWVCLASSIC:
    case EVP_PKEY_RAINBOWVCIRCUMZENITHAL:
    case EVP_PKEY_P521_RAINBOWVCIRCUMZENITHAL:
    case EVP_PKEY_RAINBOWVCOMPRESSED:
    case EVP_PKEY_P521_RAINBOWVCOMPRESSED:
