...
///// OQS_TEMPLATE_FRAGMENT_LIST_PKEY_METHS_START
    ...
    &p256_rainbowIcircumzenithal_pkey_meth,
    &rsa3072_rainbowIcircumzenithal_pkey_meth,
    &rainbowIcompressed_pkey_meth,
    &p256_rainbowIcompressed_pkey_meth,
    &rsa3072_rainbowIcompressed_pkey_meth,
    &rainbowIIIclassic_pkey_meth,
    &p384_rainbowIIIclassic_pkey_meth,
    &rainbowIIIcircumzenithal_pkey_meth,
    &p384_rainbowIIIcircumzenithal_pkey_meth,
    &rainbowIIIcompressed_pkey_meth,
    &p384_rainbowIIIcompressed_pkey_meth,
    &rainbowVclassic_pkey_meth,
    &p521_rainbowVclassic_pkey_meth,
    &rainbowVcircumzenithal_pkey_meth,
    &p521_rainbowVcircumzenithal_pkey_meth,
    &rainbowVcompressed_pkey_meth,
    &p521_rainbowVcompressed_pkey_meth,
