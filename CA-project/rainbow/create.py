...
myCmd = f'{openssl_dir}/apps/openssl req -x509 -new -newkey rainbowVclassic -keyout key_CA.key -out key_CA.pem -nodes -subj "/CN=oqstest CA" -days 365 -config {openssl_dir}/apps/openssl.cnf'
os.system(myCmd)

myCmd = f'{openssl_dir}/apps/openssl genpkey -algorithm rainbowVclassic -out key_srv.key'
os.system(myCmd)
