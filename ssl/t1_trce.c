...
///// OQS_TEMPLATE_FRAGMENT_POPULATE_SIGALG_TBL_START
    ...
    {TLSEXT_SIGALG_rainbowIclassic, "rainbowIclassic"},
    {TLSEXT_SIGALG_p256_rainbowIclassic, "p256_rainbowIclassic"},
    {TLSEXT_SIGALG_rsa3072_rainbowIclassic, "rsa3072_rainbowIclassic"},
    {TLSEXT_SIGALG_rainbowIcircumzenithal, "rainbowIcircumzenithal"},
    {TLSEXT_SIGALG_p256_rainbowIcircumzenithal, "p256_rainbowIcircumzenithal"},
    {TLSEXT_SIGALG_rsa3072_rainbowIcircumzenithal, "rsa3072_rainbowIcircumzenithal"},
    {TLSEXT_SIGALG_rainbowIcompressed, "rainbowIcompressed"},
    {TLSEXT_SIGALG_p256_rainbowIcompressed, "p256_rainbowIcompressed"},
    {TLSEXT_SIGALG_rsa3072_rainbowIcompressed, "rsa3072_rainbowIcompressed"},
    {TLSEXT_SIGALG_rainbowIIIclassic, "rainbowIIIclassic"},
    {TLSEXT_SIGALG_p384_rainbowIIIclassic, "p384_rainbowIIIclassic"},
    {TLSEXT_SIGALG_rainbowIIIcircumzenithal, "rainbowIIIcircumzenithal"},
    {TLSEXT_SIGALG_p384_rainbowIIIcircumzenithal, "p384_rainbowIIIcircumzenithal"},
    {TLSEXT_SIGALG_rainbowIIIcompressed, "rainbowIIIcompressed"},
    {TLSEXT_SIGALG_p384_rainbowIIIcompressed, "p384_rainbowIIIcompressed"},
    {TLSEXT_SIGALG_rainbowVclassic, "rainbowVclassic"},
    {TLSEXT_SIGALG_p521_rainbowVclassic, "p521_rainbowVclassic"},
    {TLSEXT_SIGALG_rainbowVcircumzenithal, "rainbowVcircumzenithal"},
    {TLSEXT_SIGALG_p521_rainbowVcircumzenithal, "p521_rainbowVcircumzenithal"},
    {TLSEXT_SIGALG_rainbowVcompressed, "rainbowVcompressed"},
    {TLSEXT_SIGALG_p521_rainbowVcompressed, "p521_rainbowVcompressed"},
